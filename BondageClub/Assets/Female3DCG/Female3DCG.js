...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "DeluxeBoots", Fetish: ["Leather"], Value: -1, BuyGroup: "MissBoots", Alpha: [{Masks: [[180, 900, 50, 100], [280, 900, 50, 100] ] }], DefaultColor: ["#9F0D0D","#700A0A","#700A0A","#9F0D0D"], Height: 35,
				Layer: [
